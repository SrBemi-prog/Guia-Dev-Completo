...
### Recursos
- 📺 [Curso de Python desde cero - MoureDev](https://www.youtube.com/watch?v=Kp4Mvapo5kc) (8 hs)
- 📺 [Python para Principiantes - Fazt Code](https://www.youtube.com/watch?v=chPhlsHoEPo)
- 📖 [Python.org tutorial oficial](https://docs.python.org/es/3/tutorial/)
- 🎮 [Práctica: CheckiO](https://checkio.org/) (juegos en Python)
- 📘 [Automate the Boring Stuff (gratis)](https://automatetheboringstuff.com/)
...
### Recursos
- 📺 [Curso JS desde cero - midudev](https://www.youtube.com/@midudev/search?query=Curso+JS+desde+cero)
- 📺 [JavaScript - Hola Mundo (Brais Moure)](https://www.youtube.com/@mouredev/search?query=JavaScript+-+Hola+Mundo)
...
- 📺 [HTML y CSS desde cero - Bluuweb](https://www.youtube.com/@bluuweb/search?query=HTML+y+CSS+desde+cero)
...
Una vez que elijas y aprendas lo básico, pasá a [03-Frontend](../03-Frontend/) o [04-Backend](../04-Backend/) según lo que más te guste.
